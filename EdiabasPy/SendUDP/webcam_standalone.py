# -*- coding: utf-8 -*-
"""
Created on Tue Jun 11 10:34:59 2024
...
def main():
    ...
    while True:
        command = input("Enter 'start' to start recording, 'stop' to stop recording, 'picture' to capture a picture, or 'exit' to quit: ").strip().lower()
        if command == 'start':
